...
with mp_pose.Pose(
    ...
    while vid.isOpened():
        start_time = time.time()  # Move this inside the loop for accurate FPS
        ...
        try:
            if results.pose_landmarks:
                ...
                # Set visibility for face landmarks to hide them
                face_landmarks = [
                ...
                if workout_type == 'PushUp':
                    cv2.putText(image, f'Push Up Counter: {push_up_counter}', (image_width - 320, 240),
                               cv2.FONT_HERSHEY_COMPLEX, 0.9, (255, 255, 255), 2, cv2.LINE_AA)
